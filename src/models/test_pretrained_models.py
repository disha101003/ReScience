...
# CiFAR100
PRETRAINED_BASE_PATH = const.BASE_DIR / \
    'models' / f'pretrained_models_{const.DATASET}'
...
def main():
    ...
    parser.add_argument(
        '--model_fw_path',
        type=Path,
        default=PRETRAINED_BASE_PATH /
        f'{const.DATASET.lower()}ft4_fw.pth',
        help='Path to the model file for fw')
    parser.add_argument(
        '--model_g_path',
        type=Path,
        default=PRETRAINED_BASE_PATH /
        f'{const.DATASET.lower()}ft4_g.pth',
        help='Path to the model file for g')
